"""
Django settings for fancy_dew_42500 project.
...
ROOT_URLCONF = 'fancy_dew_42500.urls'
...
WSGI_APPLICATION = 'fancy_dew_42500.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fancy_dew_42500 API",
    "DESCRIPTION": "API documentation for fancy_dew_42500 App",
    "VERSION": "v1",
}
